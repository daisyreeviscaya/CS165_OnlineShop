            ...
            <div class="panel panel-default">
                ...
                <div style="color:black"class="panel-body">
                    ...
                    @if(is_null($cart_id) )
                      ...
                      <div class="col-md-4">
                        <a  href = "{{url('/products')}}" type="submit"  class="btn btn-primary pull-right" role = "button">
                            Start Shopping
                        </a>
                      </div>
                        ...
                        @foreach ($orders as $order)
                          ...
                          <vr>
                           <div class="row">
                             ...
                             <div class="col-md-4">
                              <form class="form-horizontal" action="{{ url('/cart/remove') }}" method="post" >
                      {{csrf_field()}}
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <form class="form-horizontal" action="{{ url('/cart/push_cart') }}" method="post" >
                              {{csrf_field()}}
                          ...
                          <div class="col-md-2">
                            <form class="form-horizontal" action="{{ url('/cart/cancel') }}" method="post" >
                    {{csrf_field()}}
                          ...
                          <div class="col-md-4">
                            <a href="/products" class="btn btn-raised btn-success pull-left">Continue Shopping</a>
                          </div>
