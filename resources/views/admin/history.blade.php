            ...
            <div class="panel panel-default">
                ...
                <div style="color:black" class="panel-body">
                    <?php
                      ...
                      $carts = DB::table('carts')->where('user_id', $user_id)->where('status', 'sold')->get();
                      $cart_counter = 0;
                    ...
                    @if ($carts->count() == 0)
                          It seems like this user haven't ordered anything yet.
                    @else
                        ...
                        @endforeach
                    @endif
                      <a href="/home" class="btn btn-raised btn-primary pull-right">Back to home</a>
